...
(function () {
    ...
    angular.module('BlurAdmin.pages.content.message')
        .controller('MessagePageCtrl', MessagePageCtrl);

    /** @ngInject */
    function MessagePageCtrl($scope,$uibModal, baProgressModal, $filter,appBase) {
		...
		$scope.operation = function(name,id){
			...
			switch(name){
				case "审核":
					$scope.open('app/pages/content/message/messageModal.html', 'lg',id,4)
					return;
				case "发布":
					op=4;
					break;
