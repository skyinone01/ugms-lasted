...
(function () {
	...
	/** @ngInject */
	function helpModalCtrl($scope, $uibModalInstance, modelId,op, fileReader, $filter,appBase,$state) {
		 ...
		 if(modelId == 0){
		    $scope.item = {
		     ...
		     appBase.doGet("help/"+modelId,null,function(response){
		...
		$scope.saveOrUpdate = function(dismis){
		    ...
		    appBase.doFormData("help",formData,function(response){
		        appBase.bubMsg("保存成功");
				dismis;
