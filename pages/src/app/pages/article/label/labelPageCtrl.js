...
(function () {
	...
	/** @ngInject */
	function LabelPageCtrl($scope,appBase) {
		...
		$scope.listType = function(){
			appBase.doGet("articleLabel?page="+$scope.page+"&perPage="+$scope.perPage,null,function(response){
		...
		$scope.saveType = function(index){
			...
			if (data.levelname == "" || data.levelname == null){
